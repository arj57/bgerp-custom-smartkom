...
//        conDao = new ContractDAO(this.user, billingId);
    ...
    Contract getContractByTitle(String title) {
        return conDao.getContractByTitle(title);
    }
...
//            this.conDao.searchContractByTitleComment(searchResult, escapeSpecialChars(title), comment, searchOptions);
//
//        } catch (BGException e) {
